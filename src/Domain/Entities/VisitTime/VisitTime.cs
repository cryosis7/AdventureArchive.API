...
public class VisitTime : IVisitTime
{
    public DateRange VisitPeriod { get; private set; }

    protected VisitTime(DateTime arrivalTime, DateTime departureTime)
    {
        VisitPeriod = new DateRange(arrivalTime, departureTime);
    }

    protected VisitTime(DateTime arrivalTime, TimeSpan duration)
    {
        VisitPeriod = new DateRange(arrivalTime, arrivalTime.Add(duration));
    }

    protected VisitTime(DateRange visitPeriod)
    {
